...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Save the things you find online to your own little board." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "someday" },
      { property: "og:title", content: "someday · A home for your wishlist" },
      { property: "og:description", content: "Save the things you find online to your own little board." },
      ...
      { name: "twitter:title", content: "someday · A home for your wishlist" },
      { name: "twitter:description", content: "Save the things you find online to your own little board." },
